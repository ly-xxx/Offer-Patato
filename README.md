...
OfferPotato 是一个本地优先的面试准备工作台，用统一的索引、检索与生成链路处理三类输入：
...
OfferPotato 不限定领域。对于任意岗位或方向，只需提供相应的学习资料、面经题库以及候选人的工作材料，就可以用同一套流程构建文档站、面经反引与个性化回答。
...
<a href="https://www.star-history.com/?repos=ly-xxx%2FOffer-Patato&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=ly-xxx/Offer-Patato&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=ly-xxx/Offer-Patato&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/image?repos=ly-xxx/Offer-Patato&type=date&legend=top-left" />
 </picture>
</a>
